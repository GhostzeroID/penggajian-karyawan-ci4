<div class="content-wrapper" style="min-height: 651px;">
    ...
    <section class="content">
        <div class="container-fluid">
            <form method="post" action="<?= base_url('laporandataabsensipegawai') ?>" style="margin-top:10px;">
...
<script>
    ...
    function printData() {
        ...
        foreach ($kehadiran as $row) : ?>
            ...
            printWindow.document.write('<td>Hadir</td>');
            printWindow.document.write('<td><?= $row['hadir']; ?></td>');
            printWindow.document.write('</tr>');

            printWindow.document.write('<tr>');
            printWindow.document.write('<td><?= $no++; ?></td>');
            printWindow.document.write('<td>Izin</td>');
            printWindow.document.write('<td><?= $row['sakit']; ?></td>');
            printWindow.document.write('</tr>');

            printWindow.document.write('<tr>');
            printWindow.document.write('<td><?= $no++; ?></td>');
            printWindow.document.write('<td>Alpha</td>');
