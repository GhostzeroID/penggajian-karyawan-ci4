...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="card card-primary" style="max-width: 400px; margin: auto; margin-top: 50px;">
            ...
            <!-- form start -->
            <form id="quickForm" novalidate="novalidate" method="post" action="<?= base_url('login') ?>">
                <div class="card-body">
                    <!-- Bootstrap Alert -->
